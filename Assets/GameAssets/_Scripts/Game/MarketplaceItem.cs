...
public class MarketplaceItem : MonoBehaviour
{
    ...
    public async void Initialize()
    {
        ...
        // var nftContract = ThirdwebManager.Instance.GetContract(GameContracts.NFT_Contract);
        // var nft = await nftContract.ERC1155.Get(tokenId);
        // nameText.text = nft.metadata.name;
        // image.sprite = await ThirdwebManager.Instance.storage.DownloadImage(nft.metadata.image);
        //
        ...
        // }
        //
        // var marketplaceContract = ThirdwebManager.Instance.GetContract(GameContracts.MARKETPLACE_CONTRACT);
    ...
    private async void ListItem(string currencyAddress)
    {
        try
        {
            ...
            // var contract = ThirdwebManager.Instance.GetContract(GameContracts.MARKETPLACE_CONTRACT);
